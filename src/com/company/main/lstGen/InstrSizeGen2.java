...
import static com.company.main.lstGen.InstrSizeGen.imm32isOk;
import static com.company.main.lstGen.InstrSizeGen.imm8isOk;
import static com.company.main.lstGen.OpCodeGenerator.*;

/**
 * Instruction size generator at the 2nd pass
 */
public class InstrSizeGen2 {
    ...
    public static void generateSize(Line line) {
        if(KeyWordMatch.isEnd(line.getString())){
//            if ((LineHandler.curLine != null) &&
//                    !(LineHandler.curLine.content.getContentType().equals(ContentType.ENDS)))
